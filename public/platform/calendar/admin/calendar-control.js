...
$(function () {
    var update_data = function () {
        var _ref5 = _asyncToGenerator( /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.mark(function _callee5(info) {
            var date_start, time_start, date_end, time_end, data;
            return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.wrap(function _callee5$(_context5) {
                while (1) {
                    switch (_context5.prev = _context5.next) {
                        case 0:
                            console.log(info.event.end);
                            date_start = moment(info.event.start).format('YYYY-MM-DD');
                            time_start = moment(info.event.start).format("HH:mm:ss");

                            if (info.event.end !== null) {
                                date_end = moment(info.event.end).format("YYYY-MM-DD");
                                time_end = moment(info.event.end).format("HH:mm:ss");
                            } else {
                                date_end = date_start;
                                time_end = time_start;
                            }
        ...
        return function update_data(_x5) {
    ...
    var save_data = function () {
        ...
        return function save_data(_x6) {
            return _ref6.apply(this, arguments);
        };
    }();

    var delete_event = function () {
        var _ref7 = _asyncToGenerator( /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.mark(function _callee7(event) {
        ...
        return function delete_event(_x7) {
    ...
    var calendar = new FullCalendar.Calendar(calendarEl, {
        ...
        select: function () {
            var _ref = _asyncToGenerator( /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.mark(function _callee(info) {
                var date_start, time_start, date_end, time_end, today;
                        ...
                        switch (_context.prev = _context.next) {
                            case 0:
                                ...
                                if (check_date_event(info)) {
                                    date_start = moment(info.start).format('YYYY-MM-DD');
                                    time_start = moment(info.start).format("HH:mm:ss");
                                    date_end = moment(info.end).format("YYYY-MM-DD");
                                    time_end = moment(info.end).format("HH:mm:ss");
        ...
        eventResize: function () {
            var _ref2 = _asyncToGenerator( /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.mark(function _callee2(resizeInfo) {
        ...
        eventDrop: function () {
            var _ref3 = _asyncToGenerator( /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.mark(function _callee3(dropInfo) {
        ...
        eventClick: function () {
            var _ref4 = _asyncToGenerator( /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.mark(function _callee4(info) {
                var deleteMsg;
                    ...
                    while (1) {
                        switch (_context4.prev = _context4.next) {
                            case 0:
                                ...
                                deleteMsg = confirm("Do you really want to delete?");
                                ...
                                _context4.next = 5;
                                return delete_event(info.event);
    ...
    $('.save-time').click(_asyncToGenerator( /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.mark(function _callee8() {
        var data;
